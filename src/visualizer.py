    ...
    def crear_timeline_clasificaciones(self):
        ...
        for clasificacion in ['LATERAL', 'INTERMEDIO', 'FUERTE']:
            ...
            fig.add_trace(go.Scatter(
                ...
                mode='markers+lines',
                name=clasificacion,
                marker={'size': 10, 'color': color_map[clasificacion]},
                line={'width': 1, 'color': color_map[clasificacion]},
                hovertemplate=(
                    '<b>%{x|%Y-%m-%d}</b><br>' +
                    f'{clasificacion}<br>' +
                    'Rango: %{y:.1f} pts<br>' +
        ...
        fig.add_trace(go.Scatter(
            ...
            mode='lines',
            name='Tendencia',
            line={'dash': 'dash', 'color': '#6b7280', 'width': 2},
            hoverinfo='skip'
        ))
            ...
            if len(datos_ae) > 0:
                ...
                fig.add_trace(
                    go.Scatter(
                        ...
                        y=datos_ae['EUROPA'],
                        mode='markers',
                        marker={'size': 8, 'color': self.colores['ASIA'], 'opacity': 0.6},
                        name='Asia-Europa',
            ...
            if len(datos_en) > 0:
                ...
                fig.add_trace(
                    go.Scatter(
                        ...
                        y=datos_en['NY'],
                        mode='markers',
                        marker={'size': 8, 'color': self.colores['NY'], 'opacity': 0.6},
                        name='Europa-NY',
